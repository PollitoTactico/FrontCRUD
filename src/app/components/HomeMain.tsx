...
const HomeMain: React.FC<HomeMainProps> = ({ userName }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F3EFE0] flex flex-col items-start">
      {/* Logo SG arriba, fuera de la barra lateral */}
      <div className="pl-8 pt-6">
        <img src="/Images/logoSG.svg" alt="Logo SG" className="w-12 h-12" />
      </div>
      {/* Barra lateral debajo del logo */}
      <div className="flex flex-row w-full">
        ...
        {/* Contenido principal: Formulario de Perfil Usuario */}
        <main className="flex-1 flex flex-col items-center justify-start pt-10">
          <div className="relative bg-[#222222] rounded-xl shadow-lg p-8 w-[1200px]">
            {/* Botón de guardar en la esquina superior derecha, más grande y con imagen */}
            <button
              type="submit"
              form="profileForm"
            ...
            <form id="profileForm" className="flex flex-col gap-4" onSubmit={handleSubmit}>
              {/* Fila 1: Nombre del perfil y Empresa */}
              ...
              {/* Fila 2: Misión del cargo y Título del cargo */}
              <div className="flex gap-6">
                <div className="flex flex-col flex-1">
              ...
              {/* Fila 3: Departamento y Formación académica */}
              <div className="flex gap-6">
                <div className="flex flex-col flex-1">
